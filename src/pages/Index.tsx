...
const faqData = [
  ...
  {
    q: "Можно ли девушкам?",
    a: "Да, девушкам можно на любые направления. Подберём формат и нагрузку под ваш уровень подготовки.",
  },
  {
    q: "Что брать с собой?",
...
ООО «Единый учебно-аттестационный центр», инструктор по огневой подготовке.
АНО ДПО «Российский университет спецназа», курс «Спецразведка».
УЦ «Ратное дело», курс «Сапер-разведчик».
ЦТОП «Партизан»: курсы «Ближний контакт», «Оперативный пистолет», «Тактика-окопы» и др.
АНО ДПО «Сибирский институт безопасности» — инструктор массового обучения навыкам оказания первой помощи.

Стаж работы с детьми более 10 лет.

Постоянный участник и разработчик программ для детских и взрослых сборов военной и военно-патриотической направленности.

Награждён государственными наградами, а также благодарственными письмами правительства за личный вклад в воспитании детей и содействие СВО.`,
  },
  {
...
const Index = () => {
    ...
    dynamicReviews.length > 0
      ...
      : [
          ...
          },
          {
            ...
            outcome: "Уверенная работа в составе малой группы",
            type: "military" as const,
          },
          {
            text: "Освежил работу с АК и манипуляции под стрессом — на стрельбах меньше шума в голове, больше автоматизма и безопасности в обращении.",
            author: "Иван, 32 года",
            course: "Оператор АК",
            outcome: "Результативная стрельба под нагрузкой",
            type: "military" as const,
          },
          {
  ...
  return (
    ...
    <div className="min-h-screen pb-28 md:pb-0">
      ...
      {/* WHY US / О центре */}
      <section id="about" className="py-12 md:py-20 px-4 md:px-8 border-b border-border/60 bg-card/40">
